...
export type PreviewCapability = 'preview' | 'search' | 'select-text' | 'copy' | 'download' | 'print' | 'zoom' | 'rotate' | 'pages' | 'layers' | 'playback';
...
export type ViewerPhase = 'idle' | 'loading-source' | 'detecting' | 'loading-adapter' | 'opening' | 'ready' | 'error';
